...
if (isset($_POST['brojRadnika'])) {
    ...
    $post1 = filter_var($_POST['post1'], FILTER_SANITIZE_NUMBER_FLOAT);
    $post2 = filter_var($_POST['post2'], FILTER_SANITIZE_NUMBER_FLOAT);
    $post3 = filter_var($_POST['post3'], FILTER_SANITIZE_NUMBER_FLOAT);
    $post4 = filter_var($_POST['post4'], FILTER_SANITIZE_NUMBER_FLOAT);
    $post5 = filter_var($_POST['post5'], FILTER_SANITIZE_NUMBER_FLOAT);
