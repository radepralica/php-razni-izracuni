...
<nav class="shadow p-3 mb-5 bg-body rounded navbar navbar-expand navbar-light bg-light container">
    ...
    <ul class="navbar-nav ">
    <li  class="navitem img-responsive "><a href="<?php echo 'index.php';?>"><img class="data-bs-toggle="tooltip" data-bs-placement="bottom" data-bs-html="true" title="Home" src="logo.png" alt=""></a></li>
